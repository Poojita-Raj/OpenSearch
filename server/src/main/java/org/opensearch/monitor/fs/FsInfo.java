...
public class FsInfo implements Iterable<FsInfo.Path>, Writeable, ToXContentFragment {
    ...
    public static class Path implements Writeable, ToXContentObject {
        ...
        public Path(StreamInput in) throws IOException {
            ...
            if (FeatureFlags.isEnabled(FeatureFlags.SEARCHABLE_SNAPSHOT) && in.getVersion().onOrAfter(Version.V_2_5_0)) {
        ...
        public void writeTo(StreamOutput out) throws IOException {
            ...
            if (FeatureFlags.isEnabled(FeatureFlags.SEARCHABLE_SNAPSHOT) && out.getVersion().onOrAfter(Version.V_2_5_0)) {
